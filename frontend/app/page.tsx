            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Button size="lg" variant="outline" asChild>
                  <Link href="/xray-analysis">Analyze X-ray</Link>
                </Button>
                <Button size="lg" variant="outline" asChild>
                  <Link href="/blood-analysis">Analyze Blood Tests</Link>
                </Button>
              </div>
            </div>
        ...
        <div className="container px-4 md:px-6 text-center">
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="flex justify-center">
              ...
              <Button size="lg" className="ml-3" variant="secondary" asChild>
                <Link href="/xray-analysis">Try X-ray Analysis</Link>
              </Button>
              <Button size="lg" className="ml-3" variant="secondary" asChild>
                <Link href="/blood-analysis">Try Blood Analysis</Link>
              </Button>
            </div>
          </div>
        </div>
